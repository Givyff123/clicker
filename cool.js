...
goldenCookie1Button.addEventListener("click", () => {
    let bonus = Math.floor(Math.random() * Math.floor(points/2)) + Math.floor(points/2); 
    points += bonus;
    pointdisplay.innerText = "Cupcakes: " + points;
